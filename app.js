...
var LeagueConnector = require('league-connector')
var connector = new LeagueConnector()
...
ipcMain.on('setRole', (event, int, newrole1, newrole2) => {
  role1 = newrole1
  role2 = newrole2
  setRole_enabled = !setRole_enabled
